...
export function Room() {
    ...
    async function handleSendQuestion(event: FormEvent){
        ...
        await push(ref(database,`rooms/${roomId}/questions`),questions);
    ...
    async function handleLikeQuestion(questionId:string) {
        // const newLike = await database.ref(`rooms/${roomId}/questions/${questionsId}/likes`).push({
        //     author: user? id,
        // })
        //const newLike = await push(ref(database,`rooms/${roomId}/questions/${questionsId}/likes`),{authorId: user?.id})
    }
